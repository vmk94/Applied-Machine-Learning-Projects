...
for c in np.arange(1,6):
    ...
    Train_Data_NB, Test_Data_NB, Y_train_NB, Y_test_NB = CV.k_fold(DataSet_NB, Y, c)
...
Accuracy_mean_NB_DS2 = np.mean(Accuracy_vector_NB)
Accuracy_mean_LR_DS2 = np.mean(Accuracy_vector_LR)

print("Average Accuracy: ")
print(Accuracy_mean_NB_DS2)
